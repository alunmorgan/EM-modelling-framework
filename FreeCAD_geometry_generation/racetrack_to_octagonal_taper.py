...
INPUT_PARAMETERS = {'pipe_height': 10, 'pipe_width': 40, 'pipe_length': 80,
                    'octagon_height': 20, 'octagon_width': 60, 'octagon_length': 20,
                    'octagon_side_length': 8, 'octagon_tb_length': 20,
                    'taper_length': 30}
...
def racetrack_to_octagonal_cavity_model(input_parameters):
    ...
    try:
        ...
        beampipe2 = make_beampipe(face2, input_parameters['octagon_length'])
