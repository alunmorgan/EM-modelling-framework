function [wi_quad_x, wi_quad_y, wi_dipole_x, wi_dipole_y] = extract_transverse_wake_impedance_from_wake_data(wake_data, processing_type)
...
if strcmp(processing_type, 'GdfidL')
    wi_quad_x.scale = wake_data.raw_data.Wake_impedance_trans_quad_X(:,1)*1E-9;
    wi_quad_x.data = wake_data.raw_data.Wake_impedance_trans_quad_X(:,2);
    
    wi_quad_y.scale = wake_data.raw_data.Wake_impedance_trans_quad_Y(:,1)*1E-9;
    wi_quad_y.data = wake_data.raw_data.Wake_impedance_trans_quad_Y(:,2);
    
    wi_dipole_x.scale = wake_data.raw_data.Wake_impedance_trans_dipole_X(:,1)*1E-9;
    wi_dipole_x.data = wake_data.raw_data.Wake_impedance_trans_dipole_X(:,2);
    
    wi_dipole_y.scale = wake_data.raw_data.Wake_impedance_trans_dipole_Y(:,1)*1E-9;
    wi_dipole_y.data = wake_data.raw_data.Wake_impedance_trans_dipole_Y(:,2);
