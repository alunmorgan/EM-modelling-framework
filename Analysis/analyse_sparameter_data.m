function analyse_sparameter_data(root_path, model_set)
...
for kaw = 1:length(sets)
    ...
    [s_mat, sparameter_data.excitation_list, sparameter_data.reciever_list] = ...
        GdfidL_find_s_parameter_ouput(sets{kaw});
    [sparameter_data.scale,  sparameter_data.data] = read_s_param_datafiles(s_mat);
    
    fprintf('Analysed ... Saving...')
    save(fullfile(sets{kaw}, 'sparameter', 'data_analysed_sparameter.mat'), 'sparameter_data','-v7.3')
    fprintf('Saved\n')
