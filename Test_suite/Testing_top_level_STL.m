...
log = {'Log of problems'};
base_model_names = {'pillbox_cavity', 'simple_buttons', ...
                    'racetrack_to_octagonal_taper',...
                    'octagonal_to_racetrack_taper',...
                    'racetrack_tapered_cavity'};  
base_model_names(4) = []; %TEMP - REMOVEBEFORE COMMIT
