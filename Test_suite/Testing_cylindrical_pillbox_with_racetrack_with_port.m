...
%
% Example: Testing_cylindrical_pillbox_with_racetrack_with_port(input_file_loc, scratch_loc, data_loc, results_loc)
...
run_inputs.model_name = 'cylindrical_pillbox_with_racetrack_with_port';
...
% tried).
run_inputs.s_param_ports = {'port_signal_out'};
...
run_inputs.port_multiple = [1,1,1];
...
run_inputs.port_fill_factor = [1,1,1];
