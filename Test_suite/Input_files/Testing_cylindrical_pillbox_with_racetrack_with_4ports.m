...
run_inputs.model_set = {'cylindrical_pillbox_with_racetrack_with_4ports'};

%% Adding list of model names to run.
run_inputs.model_names = {'cylindrical_pillbox_with_racetrack_with_4ports'};
...
run_inputs.simulation_defs.wakelength = {'105'}; %in m
