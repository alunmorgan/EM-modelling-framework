function Testing_rectangular_pillbox(input_file_loc, scratch_loc, data_loc)
...
run_inputs.model_set = {'rectangular_pillbox'};

%% Adding list of model names to run.
run_inputs.model_names = {'rectangular_pillbox'};
...
for shew = 1:length(run_inputs.model_names)
    ...
    run_inputs.geometry_defs{shew} = {...
        {'extension_length', {50e-3, 70e-3, 90e-3, 110e-3},'Length of the model extensions.'},...
...
run_inputs.simulation_defs.versions = {'170509g'};%{'161207g', '160210g','160410g','160429g','160517g','161003g','161108g', '170509g'};%{'161003g'};
