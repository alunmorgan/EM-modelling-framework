function Testing_cylindrical_pillbox_with_port(input_file_loc, scratch_loc,...
    data_loc)
...
run_inputs.model_set = {'cylindrical_pillbox_with_port'};

%% Adding list of model names to run.
run_inputs.model_names = {'cylindrical_pillbox_with_port'};
...
for shew = 1:length(run_inputs.model_names)
    ...
    run_inputs.geometry_defs{shew} = {{'extension_length', {100e-3},'Length of the model extensions.'},...
        {'pipe_rad', {10e-3},'Radius of the beam pipe.'},...
        {'cav_length', {42e-3}, 'Length of the cavity.'},...
        {'cav_rad', {65e-3}, 'Radius of the cavity.'},...
        };
end %for
...
% tried).
run_inputs.simulation_defs.s_param_ports = {'port_signal_out'};
...
run_inputs.simulation_defs.port_multiple = [1,1,1];
...
run_inputs.simulation_defs.port_fill_factor = [1,1,1];
