function Testing_rectangular_pillbox_with_port(input_file_loc, scratch_loc,...
    data_loc)
...
%
% Example: Testing_cylindrical_pillbox_with_port(input_file_loc, scratch_loc, data_loc)
...
run_inputs.model_set = {'rectangular_pillbox_with_port'};

%% Adding list of model names to run.
run_inputs.model_names = {'rectangular_pillbox_with_port'};
...
for shew = 1:length(run_inputs.model_names)
    ...
    run_inputs.geometry_defs{shew} = {...
        ...
        {'pipe_width', {10e-3},'Radius of the beam pipe.'},...
        {'pipe_height', {10e-3},'Radius of the beam pipe.'},...
        {'cav_length', {42e-3}, 'Length of the cavity.'},...
        {'cav_width', {65e-3}, 'Width of the cavity.'},...
        {'cav_height', {65e-3}, 'Height of the cavity.'},...
        {'pin_radius', {0.64e-3}, 'Coaxial pin radius'},...
        {'coax_radius', {3.5e-3/2}, 'Coax outer radius'},...
        };
end %for
...
run_inputs.simulation_defs.mesh_stepsize = {'500E-6'}; %in m
run_inputs.simulation_defs.wakelength = {'16'};
...
% tried).
run_inputs.simulation_defs.s_param_ports = {'port_signal1'};
...
run_inputs.simulation_defs.port_multiple = [1,1,4];
...
run_inputs.simulation_defs.port_fill_factor = [0.25,0.25,1];
