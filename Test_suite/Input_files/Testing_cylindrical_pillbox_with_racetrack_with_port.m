function Testing_cylindrical_pillbox_with_racetrack_with_port(input_file_loc, scratch_loc,...
    data_loc)
...
run_inputs.model_set = {'cylindrical_pillbox_with_racetrack_with_port'};

%% Adding list of model names to run.
run_inputs.model_names = {'cylindrical_pillbox_with_racetrack_with_port'};
