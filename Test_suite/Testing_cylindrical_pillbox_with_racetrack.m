function Testing_cylindrical_pillbox_with_racetrack(input_file_loc, scratch_loc,...
    data_loc, version)
...
%
% Example: Testing_cylindrical_pillbox_with_racetrack(input_file_loc, scratch_loc, data_loc, results_loc)
...
%% Input paramters for the model setup
...
run_inputs.model_name = 'cylindrical_pillbox_with_racetrack';
