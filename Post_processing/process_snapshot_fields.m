...
delete(w)
    ...
    function construct_snapshot_file(test_input)
        % Find boundary limits using the first data file of the set.
        temp_boundary1 = test_input(find(contains(test_input, [': ','ix1']),1, 'first'));
        temp_boundary2 = test_input(find(contains(test_input, [': ','ix2']),1, 'first'));
        ...
        temp_boundary3 = test_input(find(contains(test_input, [': ','iy1']),1, 'first'));
        temp_boundary4 = test_input(find(contains(test_input, [': ','iy2']),1, 'first'));
        ...
        temp_boundary5 = test_input(find(contains(test_input, [': ','iz1']),1, 'first'));
        temp_boundary6 = test_input(find(contains(test_input, [': ','iz2']),1, 'first'));
