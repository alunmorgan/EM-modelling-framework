...
plot_s_param_graph(pp_data, modelling_inputs.beam, cols_sep, fig_pos, pth, lower_cutoff, linewidth)
...
if strcmp(modelling_inputs.beam, 'yes') && size(pp_data.all_ports,1) > 2
    plot_s_parameter_transmission_graphs_port(pp_data, modelling_inputs.beam, cols_sep, lines, fig_pos, pth, lower_cutoff, linewidth)
    plot_s_param_transmission_graphs_modes(pp_data, modelling_inputs.beam, cols_sep, lines, fig_pos, pth, lower_cutoff, linewidth)
