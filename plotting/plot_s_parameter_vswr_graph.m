function plot_s_parameter_vswr_graph(data, cols, lines, fig_pos, ...
...
ylabel('VSWR')
title('VSWR of signal ports')
savemfmt(h, pth,[prefix, '_s_parameters_vswr'])
close(h)