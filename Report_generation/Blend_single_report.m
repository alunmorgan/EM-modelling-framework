...
if exist('loss_names', 'var') == 2
    ...
    ov1 = latex_top_bottom_images('Thermal_absolute_losses_within_the_structure.pdf',...
        'Thermal_fractional_loss_distribution_within_the_structure.pdf',...
...
capE = ['An overlay of ',...
    ...
    ov1 = latex_top_bottom_images([report_input.rep_title, ' - cumulative_total_energy.pdf'],...
        [report_input.rep_title, ' - Energy.pdf'],...
...
ov1 = latex_top_bottom_images([report_input.rep_title, ' - wake_potential.pdf'], ...
    [report_input.rep_title, ' - longitudinal_wake_impedance_real.pdf'], ...
    'Wake potential','Wake impedance real', ...
    'wake_potential', 'wake_impedance_real', 1, 1);
ov = cat(1,ov,ov1);
ov1 = latex_top_bottom_images([report_input.rep_title, ' - longitudinal_wake_impedance_imaginary.pdf'], ...
    [], ...
        ...
        for ha = 3:num_ports
            for ks = 1:2 % number of modes desired
                ...
                if state == 1
                    ...
                    ov1 = latex_top_bottom_images([out_name, '.pdf'], ...
                        [out_name, '_3D.pdf'],lab,[lab,' 3D'], ...
                        lab, [lab,'_3D'], 1, 0.8);
                    ov = cat(1,ov,ov1);
                    ov = cat(1,ov,'\clearpage');
                    ov1 = latex_single_image([out_name, '_diff.pdf']...
