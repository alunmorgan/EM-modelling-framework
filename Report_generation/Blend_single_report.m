...
if state == 1
    ov1 = latex_top_bottom_images('cumulative_total_energy.eps', 'Energy.eps',...
...
summary = {['Figure \ref{',labs{1},'} ',...
    ...
    ['Figure \ref{',labs{2},'} shows the real part of the wake impedance. ',...
