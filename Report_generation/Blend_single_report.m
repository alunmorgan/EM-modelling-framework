...
capE = ['An overlay of ',...
    ...
    ov1 = latex_top_bottom_images('cumulative_total_energy.pdf',...
        'Energy.pdf',...
...
ov1 = latex_top_bottom_images('wake_potential.pdf', ...
    'longitudinal_wake_impedance_real.pdf', ...
    'Wake potential','Wake impedance real', ...
    'wake_potential', 'wake_impedance_real', 1, 1);
ov = cat(1,ov,ov1);
ov1 = latex_top_bottom_images('longitudinal_wake_impedance_imaginary.pdf', ...
    [], ...
