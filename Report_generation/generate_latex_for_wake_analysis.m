...
if exist('wake/Thermal_Losses_within_the_structure.eps','file') && ...
        exist('wake/Thermal_Fractional_Losses_distribution_within_the_structure.eps','file') 
...
elseif exist('wake/Thermal_Losses_within_the_structure.eps','file')
    ov1 = latex_single_image('wake/Thermal_Losses_within_the_structure.eps',...
...
ov = cat(1,ov,ov1);
ov1 = latex_side_by_side_images('wake/Energy_loss_distribution_of_bunch_and_energy_seen_at_ports.eps',...
    'wake/cumulative_Energy_loss_distribution_of_bunch_and_energy_seen_at_ports.eps',...
...
ov1 = latex_side_by_side_images('wake/wake_sweep_wlf.eps',...
    'wake/wake_sweep_energy_beam_ports.eps',...
    'Wake loss factor evolution over wake length',...
    'Beam port energy evolution over wake length');
ov = cat(1,ov,ov1);
ov1 = latex_side_by_side_images('wake/wake_sweep_energy_signal_ports.eps',...
    'wake/wake_sweep_energy_losses.eps',...
    'Signal port energy evolution over wake length',...
    'Energy loss evolution over wake length');
ov = cat(1,ov,ov1);

ov1 = latex_single_image('wake/wake_sweep_spectra.eps', '',...
    'wake_sweep_spectra',1);
ov = cat(1,ov,ov1);
ov1 = latex_single_image('wake/wake_sweep_port_impedance.eps',...
